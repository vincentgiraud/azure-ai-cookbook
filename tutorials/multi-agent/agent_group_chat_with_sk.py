...
# https://github.com/microsoft/semantic-kernel/blob/main/python/samples/learn_resources/agent_docs/agent_collaboration.py
...
""",
    ...
    while not is_complete:
        ...
        # Try to grab files from the data directory
